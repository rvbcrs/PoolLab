 ...
 *
 */
#define ST7701_3_WIRE_SPI_IO_CONFIG(line_cfg, scl_active_edge) \
    {                                분위기 \
        .line_config = line_cfg,                            \
        .expect_clk_speed = PANEL_IO_3_WIRE_SPI_CLK_MAX,    \
        .spi_mode = (scl_active_edge) ? 1 : 0,              \
        .extra_flags = {                                    \
            .scl_active_edge = scl_active_edge,             \
        },                                                  \
    }

#if SOC_MIPI_DSI_SUPPORTED
/**
 * @brief MIPI-DSI bus configuration structure for ST7701
 *
 */
#define ST7701_PANEL_BUS_DSI_2CH_CONFIG() \
    {                                     \
        .bus_id = 0,                      \
        .num_data_lanes = 2,              \
        .dpi_clock_hz = 18 * 1000 * 1000, \
    }

/**
 * @brief MIPI-DBI panel IO configuration structure for ST7701
 *
 */
...
/**
 * @brief MIPI-DPI panel configuration for ST7701, 480x360@60Hz
 *
 */
